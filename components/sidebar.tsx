					...
					<Link href='/' legacyBehavior passHref>
						<NavigationMenuLink
							className={`flex flex-col items-center justify-center rounded-full [&>svg]:hover:size-10 hover:bg-secondary min-h-14 min-w-14 size-14 transition ${
								pathName === "" && "size-14 bg-secondary [&>svg]:fill-svg-secondary [&>svg]:size-10"
							}`}
						>
							<svg
							...
							{pathName === "" && <div className='size-1 bg-svg-secondary rounded-full'></div>}
						</NavigationMenuLink>
					</Link>

					<Link href='/frontend-projects?project=1' legacyBehavior passHref>
						<NavigationMenuLink
							className={`flex flex-col items-center justify-center rounded-full min-h-14 min-w-14 [&>svg]:hover:size-10 hover:bg-secondary size-14 transition ${
								pathName === "frontend-projects" && "size-14 bg-secondary [&>svg]:fill-svg-secondary [&>svg]:size-10"
							}`}
						>
							<svg
								className='transition-all fill-svg-primary size-8'
							...
							{pathName === "frontend-projects" && <div className='size-1 bg-svg-secondary rounded-full'></div>}
						</NavigationMenuLink>
					</Link>
					<Link href='/backend-projects' legacyBehavior passHref>
						<NavigationMenuLink
							className={`flex flex-col items-center justify-center rounded-full min-h-14 min-w-14 [&>svg]:hover:size-10 hover:bg-secondary size-14 transition ${
								pathName === "backend-projects" && "size-14 bg-secondary [&>svg]:fill-svg-secondary [&>svg]:size-10"
							}`}
						>
							<svg
								className='transition-all fill-svg-primary size-8'
							...
							{pathName === "backend-projects" && <div className='size-1 bg-svg-secondary rounded-full'></div>}
						</NavigationMenuLink>
					</Link>
					<Link href='/all-projects' legacyBehavior passHref>
						<NavigationMenuLink
							className={`flex flex-col items-center justify-center rounded-full min-h-14 min-w-14 [&>svg]:hover:size-8 hover:bg-secondary size-14 transition ${
								pathName === "all-projects" && "size-14 bg-secondary [&>svg]:fill-svg-secondary [&>svg]:size-8"
							}`}
						>
							<svg
							...
							{pathName === "all-projects" && <div className='size-1 bg-svg-secondary rounded-full'></div>}
						</NavigationMenuLink>
					</Link>
