...
export interface IProjectSwiperCard {
  bgImg?: string;
  icoImg?: string;
  mainTitle?: string;
  mainSubTitle?: string;
    ...
    <div className="slider-card cursor-pointer relative max-w-full mx-4 lg:max-w-[760px] p-2 rounded-[40px] overflow-hidden">
      <div className="flex flex-col justify-center relative min-h-[300px] lg:min-h-[376px] rounded-[32px]">
        ...
        <div className="flex flex-col items-center text-center relative z-30">
          <h3 className="font-black text-4xl sm:text-5xl lg:text-[80px]">{mainTitle}</h3>
          <p className="text-secondary-foreground text-lg sm:text-xl lg:text-2xl mt-2 sm:mt-4 lg:mt-1">
            {mainSubTitle}
          </p>
        </div>
      </div>
